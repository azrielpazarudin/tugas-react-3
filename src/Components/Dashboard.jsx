            ...
            <div style={{
            ...
            }}>
                {
                    listProduct.map((value, index) => {
                        return <CardProduct key={index} title={value.productName} price={value.productPrice} imgUrl={value.urlImage} myAlert ={ ()=>{
                            alert('Product '+value.productName+' Dengan Harga '+value.productPrice+' Adalah Product Yang Amazing Ea')
                        }}/>
                    })
                }
            </div>
